...
X_train[['D5Dimer','vWFD3','D3Dimer','PrevWF','Age','vWFD1','lymphocyte','TT','FDP','PREDimer']] = scaler.fit_transform(X_train[['D5Dimer','vWFD3','D3Dimer','PrevWF','Age','vWFD1','lymphocyte','TT','FDP','PREDimer']])
X_test[['D5Dimer','vWFD3','D3Dimer','PrevWF','Age','vWFD1','lymphocyte','TT','FDP','PREDimer']] = scaler.transform(X_test[['D5Dimer','vWFD3','D3Dimer','PrevWF','Age','vWFD1','lymphocyte','TT','FDP','PREDimer']])#用训练集的参数转换验证集
#进行排序
